'use server';
/**
 * @fileOverview Provides functionality to summarize PDF documents.
 *
 * - summarizePdf - Summarizes the text content of a PDF document.
...
const SummarizePdfInputSchema = z.object({
  pdfDataUri: z
    .string()
    .describe(
      'The PDF document as a data URI that must include a MIME type and use Base64 encoding. Expected format: \'data:<mimetype>;base64,<encoded_data>\'.' /* @mingkai changed description */
    ),
});
